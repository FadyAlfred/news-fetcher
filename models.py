...
class ImageSection(Section):
    id: str = Field(
        ...,
        description="Provider internal id of the image",
        example="749",
    )
...
class MediaSection(Section):
    ...
    publication_date: datetime = Field(
        ..., alias="pub_date", description="Datetime of media publication", example="2020-07-08T20:50:43Z"
    )
...
class Article(BaseModel):
    ...
    publication_date: datetime = Field(
        ..., alias="pub_date", description="Datetime of article publication", example="2020-07-08T20:50:43Z"
    )
    ...
    modification_date: Optional[datetime] = Field(
        alias="mod_date", description="Datetime of article modification", default_factory=datetime.now
    )

    @validator("modification_date", pre=True)
